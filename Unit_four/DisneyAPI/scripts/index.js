/* 
    ...
    */
    ...
    //?Global
    let disneyUrl = 'https://api.disneyapi.dev/character';
    let randomFifty = Math.floor(Math.random() * 50);
    ...
    export const info = async(url, rng) => {
        try {
            ...
            // console.log(data);
            console.log(data.data[rng]);
            console.log(data.data[rng].name);
            console.log(data.data[rng].imageUrl);
            // console.log(data[rng].name);
            // console.log(data[rng].imageUrl);
        } catch (err) {
            console.error(err);
        }
    }

    info(disneyUrl,randomFifty);
    console.log(randomFifty);
    console.log(randomFifty);
    console.log(randomFifty);
