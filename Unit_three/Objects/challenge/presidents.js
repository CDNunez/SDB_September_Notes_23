const presidents = [
  ...
  /* 
  - how many we had
  -list of all alive presidents
  dead presidents

  using for each loop through 
  */

  console.log("Presidents we have had: ", presidents.length);//how many presidents we have had: 45

//logs list of alive presidents
...
//lists dead presidents

for ( x = 0; x <45; x++) {
    if  (typeof presidents[x].passed === 'number') {
        console.log(presidents[x]);
    }
}
...
// for (y = 0; y < 45; y++) {
//     let fullName = presidents[y].first + " " + presidents[y].last;
//     let age = presidents[y].passed - presidents[y].year;
//     if (typeof presidents[y].passed === 'number') {
//         console.log(`${fullName} was ${age} years old when they died.`);
//     }
// } this technically works but it would not update if the array or object gets more values added down the line

presidents.forEach(president => {
    if (president.passed === true) {
